      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="text-2xl font-bold text-pink-400">KatoStore</div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Cửa hàng
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Trợ giúp
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/size-guide" className="text-gray-300 hover:text-pink-400 transition-colors">
                  Hướng dẫn chọn size
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-gray-400">© 2024 KatoStore. Tất cả quyền được bảo lưu.</div>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link to="/privacy" className="text-sm text-gray-400 hover:text-pink-400 transition-colors">
                Chính sách bảo mật
              </Link>
              <Link to="/terms" className="text-sm text-gray-400 hover:text-pink-400 transition-colors">
                Điều khoản sử dụng
              </Link>
              <Link to="/cookies" className="text-sm text-gray-400 hover:text-pink-400 transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
